...
def nan_advance_jit(dt, n, bodies=SYSTEM, pairs=PAIRS):
    for i in xrange(n):
        for (([x1, y1, z1], v1, m1),
...
import timeit
print(timeit.timeit(lambda: bench_nbody(50, "sun", n), number=3))


#print("ref diff:", sys.gettotalrefcount()-a)
